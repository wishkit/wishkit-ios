...
struct AlertManager {
    ...
    static func confirmAction(on vc: UIViewController, message: String, action: @escaping () -> Void) {
        let cancelAction = UIAlertAction(title: WishKit.config.localization.cancel, style: .destructive)
        let confirmAction = UIAlertAction(title: WishKit.config.localization.confirm, style: .default) { _ in action() }
    ...
    static func confirmMessage(on vc: UIViewController, message: String) {
        let title = WishKit.config.localization.info
        let alert = UIAlertController(title: title, message: message, preferredStyle: .alert)
        let confirmAction = UIAlertAction(title: WishKit.config.localization.ok, style: .default)
